...
const MapboxWelcome: React.FC = () => {
  ...
  useEffect(() => {
    ...
    mapInstance.current = new mapboxgl.Map({  // No funciona la instancia bien de Mapbox GL JS
      ...
      style: 'mapbox://styles/mapbox/navigation-night-v1', // URL mapbox diseñado
      ...
      boxZoom: false, // permitir zoom con caja de selección
