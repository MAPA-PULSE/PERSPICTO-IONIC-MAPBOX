...
//   const filteredData = await fetchEarthquakes(formattedStart, formattedEnd);
...
//   style={{ width: '100%', padding: '0.5rem', marginTop: '0.5rem', zIndex: 20, position: 'absolute', top: '6vh', left: '4vw' }}
// >
